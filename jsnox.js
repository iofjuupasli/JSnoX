...
if (typeof(module) !== 'undefined') module.exports = jsnox(require('react'))
if (typeof define === 'function' && define.amd) define(['react'], jsnox)
else global.jsnox = jsnox(global.React)
